...
> ⚠️ כל הקישורים להלן אותרו דרך תוצאות חיפוש (WebSearch) — גישה ישירה (WebFetch) לדומיינים הרשמיים נחסמה בסביבת העבודה של שלב 2 (ראו הסתייגות ב-`source-log.md`). הקישור עצמו נכון, אך תוכנו לא נקרא במלואו ישירות. אתרי מס הכנסה/משרד חינוך טרם נבדקו — יבדקו בשלב 3 (תחום D/B).
...
| מדינה | אתר הגירה/ויזות | אתר מס הכנסה | אתר משרד חינוך | אומת לאחרונה |
|---|---|---|---|---|
| 🇳🇱 הולנד | https://ind.nl/ | ? | ? | 2026-08-18 ⚠️ (via search) |
...
| מדינה | אתר הגירה/ויזות | אתר מס הכנסה | אתר משרד חינוך | אומת לאחרונה |
|---|---|---|---|---|
| 🇩🇪 גרמניה | https://www.gesetze-im-internet.de/aufenthg_2004/ | ? | ? | 2026-08-18 ⚠️ (via search, סקירה מקוצרת) |
| 🇦🇹 אוסטריה | https://www.migration.gv.at/ | ? | ? | 2026-08-18 ⚠️ (via search, סקירה מקוצרת) |
| 🇧🇪 בלגיה | https://dofi.ibz.be/ | ? | ? | 2026-08-18 ⚠️ (via search, סקירה מקוצרת) |
| 🇫🇷 צרפת | https://www.immigration.interieur.gouv.fr/ | ? | ? | 2026-08-18 ⚠️ (via search, סקירה מקוצרת) |
| 🇭🇺 הונגריה | (לא אותר אתר ממשלתי T1 ישיר — מקור T2 בלבד) | ? | ? | 2026-08-18 ⚠️ (T2 בלבד) |
| 🇫🇮 פינלנד | https://migri.fi/en | ? | ? | 2026-08-18 ⚠️ (via search, סקירה מקוצרת) |
| 🇱🇺 לוקסמבורג | https://guichet.public.lu/ | ? | ? | 2026-08-18 ⚠️ (via search, סקירה מקוצרת) |
| 🇨🇭 שווייץ | https://www.sem.admin.ch/ | ? | ? | 2026-08-18 ⚠️ (T2 בלבד — SEM חסום) |
| 🇨🇦 קנדה | https://www.canada.ca/en/immigration-refugees-citizenship.html | ? | ? | 2026-08-18 (via search) |
| 🇦🇺 אוסטרליה | (לא אותר עמוד T1 ישיר — homeaffairs.gov.au לא נבדק) | ? | ? | 2026-08-18 ⚠️ (T2 בלבד) |
| 🇳🇿 ניו זילנד | (לא אותר עמוד T1 ישיר — immigration.govt.nz לא נבדק) | ? | ? | 2026-08-18 ⚠️ (T2 בלבד) |
| 🇺🇸 ארה"ב | (uscis.gov לא נבדק ישירות) | ? | ? | 2026-08-18 ⚠️ (T2 בלבד) |
| 🇺🇾 אורוגוואי | https://www.gub.uy/tramites/residencia-legal-temporaria | ? | ? | 2026-08-18 ⚠️ (via search) |
